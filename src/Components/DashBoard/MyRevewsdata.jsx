...
const MyRevewsdata = ({data,handledlt}) => {
    const{Proname,revname,textarea,revtime,_id,
    ...
    return (
        <div className="w-[500px] h-[200px] shadow-lg text-center font-bold bg-amber-400">
            ...
            <button onClick={()=>handledlt(_id)} className="btn bg-red-900 text-white mt-1">Delete</button>
